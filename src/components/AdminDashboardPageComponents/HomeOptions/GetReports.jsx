...
const GetReports = () => {
  ...
  const fetchUsers = async () => {
    try {
      const response = await axios.get(
        "https://pavancheckmedbackend-2.onrender.com/api/users/filter",
        {
          params: {
  ...
  const fetchQRReports = async () => {
    try {
      const response = await axios.get("https://pavancheckmedbackend-2.onrender.com/api/qr-reports", {
        params: {
          city: filters.city,
          companyName: filters.companyName,
        },
  ...
  const handleClear = async () => {
    ...
    try {
      if (activeTab === "user") {
        const response = await axios.get("https://pavancheckmedbackend-2.onrender.com/api/users");
        setUsers(response.data);
      } else {
        const response = await axios.get("https://pavancheckmedbackend-2.onrender.com/api/qr-reports");
        setQRReports(response.data);
